...
export const CONTRACT_ABI = [
  ...
  { "anonymous": false, "inputs": [{ "indexed": true, "name": "credentialHash", "type": "bytes32" }, { "indexed": true, "name": "issuer", "type": "address" }], "name": "CredentialIssued", "type": "event" },
  ...
  { "inputs": [{ "name": "", "type": "bytes32" }], "name": "credentialIssuers", "outputs": [{ "name": "", "type": "address" }], "stateMutability": "view", "type": "function" },
  { "inputs": [{ "name": "credentialHash", "type": "bytes32" }], "name": "issueCredential", "outputs": [], "stateMutability": "nonpayable", "type": "function" },
